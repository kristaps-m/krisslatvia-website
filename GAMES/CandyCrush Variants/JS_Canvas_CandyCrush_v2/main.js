...
function horizontalCrushing() {
    for (let theRow = 0; theRow < mainGeneratedListOfCells.length; theRow++) {
        for (let col = 0; col < mainGeneratedListOfCells[0].length - 2; col++) {
            if(mainGeneratedListOfCells[theRow][col].randomColorNumber != 0
                && Math.abs(mainGeneratedListOfCells[theRow][col].randomColorNumber === mainGeneratedListOfCells[theRow][col + 1].randomColorNumber)
                && Math.abs(mainGeneratedListOfCells[theRow][col].randomColorNumber === mainGeneratedListOfCells[theRow][col + 2].randomColorNumber)
            ){
                mainGeneratedListOfCells[theRow][col].run = true;
                mainGeneratedListOfCells[theRow][col].randomColorNumber = mainGeneratedListOfCells[theRow+1][col].randomColorNumber = mainGeneratedListOfCells[theRow+2][col].randomColorNumber = -Math.abs(mainGeneratedListOfCells[theRow][col].randomColorNumber)
            }
